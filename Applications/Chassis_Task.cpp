...
namespace Applications::Chassis_Task{
    ...
    void Chassis_Task(void *pvPara){
        ...
        // Enable Motors
        GM6020_id1.enable(); GM6020_id2.enable(); GM6020_id3.enable(); GM6020_id4.enable();
        M3508_id1.enable(); M3508_id2.enable(); M3508_id3.enable(); M3508_id4.enable();
    ...
    void init(){
        xTaskCreateStatic(Chassis_Task, "Chassis_Task", 2048, NULL, 0, uxChassisTaskStack, &xChassisTaskTCB);
    }
}